...
//import Lineage_sources from "../../../public/vocables/modules/tools/lineage/lineage_sources";
...
var Idcp = (function () {
    ...
    self.CSVbutton = '<button  onclick="Export.exportGraphToDataTable()">CSV</button>';
    self.SVGbutton = '<button  onclick="visjsGraph.toSVG()">SVG</button>';
    ...
    self.onGraphOrTreeNodeClick = function (node, nodeEvent, options) {
        ...
        if (nodeEvent.ctrlKey && nodeEvent.shiftKey) {
            if (options.callee == "Graph") {
                // remove literals
                Lineage_relations.drawRelations(null, null, "Graph", { skipLiterals: 1, includeSources: self.BO_source });
    ...
    self.adding_parameter_processus = function (data, process_step) {
        if (process_step.paramOrProp == "param") {
            if (process_step.step == 0) {
                ...
                $("#parameter_uri")
                    .parent()
                    .html("<br><br>Parameter :" + $("#parameter_uri").parent().html());
                $("#bo_uri").show();
                $("#bo_uri")
                    .parent()
                    .html("<br><br>Search a Business object to associate :" + $("#bo_uri").parent().html());
            ...
            if (process_step.step == 1) {
                ...
                $("#unit_of_mesure")
                    .parent()
                    .html("<br><br> Add a unit of mesure :   " + $("#unit_of_mesure").parent().html());
                $("#LineageBlend_creatingNodeNewClassDefinition")
                    .parent()
                    .html("<br><br> Add a definition :   <br> " + $("#LineageBlend_creatingNodeNewClassDefinition").parent().html());
            ...
            if (process_step.step == 0) {
                ...
                $("#property_uri")
                    .parent()
                    .html("<br><br>Property :" + $("#property_uri").parent().html());
                $("#parameter_uri").show();
                $("#parameter_uri")
                    .parent()
                    .html("<br><br>Search a Parameter to associate :" + $("#parameter_uri").parent().html());
    ...
    self.IDCP_paste_container = function (e) {
        ...
        common.pasteTextFromClipboard(function (text) {
            ...
            try {
                ...
                if (Lineage_containers.currentContainer.data["rdf:types"]) {
                    if (Lineage_containers.currentContainer.data["rdf:types"].length > Lineage_containers.currentContainer.data["type"].length) {
                        Lineage_containers.currentContainer.data["type"] = Lineage_containers.currentContainer.data["rdf:types"];
                    }
                }
    ...
    self.IDCPDisplayGraphContainersLeaves = function (e) {
        ...
        Lineage_containers.graphResources(source, Lineage_containers.currentContainer.data, { leaves: true }, function () {
            ...
            if (!self.loadedGraphDisplay) {
                $("#graphDiv").prepend(self.SVGbutton);
                $("#graphDiv").prepend(self.CSVbutton);
    ...
    self.idcp_addDataContainer = function (e) {
        ...
        Sparql_generic.getNodeInfos(
            ...
            function (err, data) {
                if (data.length > 0) {
                    containerUri = containerUri + "_" + common.getRandomHexaId(6);
                }
    ...
    self.idcp_addParameter = function (dialogdiv, source) {
        ...
        if (!Field_completed) {
            ...
            Sparql_generic.getNodeInfos(
                ...
                function (err, data) {
                    if (data.length > 0) {
                        uri = uri + "_" + common.getRandomHexaId(6);
                        Lineage_blend.graphModification.creatingNodeTriples.forEach((result) => {
                            result.subject = uri;
                        });
                    }
    ...
    self.loadLegend = function () {
        //Legend diagram
        $("#rightPanelDiv").parent().append(`
         <div id='icons'>
         <div id='text_img' style="font-size: 24pt" > Icons meaning </div>
         <br>
         <img id='datacontainer_img' src="../icons/datacontainer.png" width="20"  > Datacontainer
         <br>
         <img id='datablock_img' src="../icons/datablock.png" width="20"  > Datablock
          <br>
         <img id='parameter_img' src="../icons/Parameter.png" width="20"  > Parameter
         <br>
         <img id='properties_img' src="../icons/properties.png" width="20" > Properties
         <br>
         <img id='disciplines_img' src="../icons/disciplines.png" width="20" > Disciplines
         <br>
         <img id='bo_img' src="../icons/bo.png" width="20" > Business Object
         <br>
         <img id='enumeration_img' src="../icons/enumeration.png" width="20" > Enumeration
         <br>
         <img id='attribute_img' src="../icons/attribute.png" width="20" > Attribute
         <br>
    ...
    self.onLoaded = function () {
        ...
        html_content.load("/vocables/snippets/lineage/lineageRightPanel.html #LineageContainersTab", function () {
            ...
            Lineage_sources.registerSourceImports(self.source);
            Lineage_classes.onGraphOrTreeNodeClick = self.onGraphOrTreeNodeClick;

            //Lineage_sources.setAllWhiteBoardSources();
